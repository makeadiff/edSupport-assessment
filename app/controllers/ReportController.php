...
//     return $data;
   ...
   public function getCSV($year){
      ...
      //----------------------------------------------------------
        ...
        if($user_sub_id == null || $batch_id == null){
        ...
        else if($user_sub_id == "0" && $batch_id != null){
          if(!isset($data_array[$i]['english'])){
            $data_array[$i]['english'] = 1;
          }
          if(!isset($data_array[$i]['math'])){
